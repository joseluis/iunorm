...
macro_rules! norm_sizes {
    // multiple sizes
    ( $( [$size:literal, $utype:ty, $itype:ty] ),+ ) => {
        $( norm_sizes!{@ $size, $utype, $itype} )+
    };
    // single size
    (@ $size:literal, $utype:ty, $itype:ty) => { paste::paste!{
        /* Unsigned */
...
norm_sizes! { [8, u8, i8], [16, u16, i16], [32, u32, i32], [64, u64, i64], [128, u128, i128] }
